...
import enUS from '@root/docs/cheatsheet.en-US.md?raw';
import zhCN from '@root/docs/cheatsheet.zh-CN.md?raw';
...
const infoCards = [
  {
    ...
    titleDefault: '学习 umi',
    descDefault:
      'umi 是基于路由的、可扩展的企业级前端框架，同时支持配置式路由和约定式路由。',
  },
  {
    index: 2,
    href: 'https://ant.design',
    titleDefault: '学习 Ant Design',
    descDefault:
  ...
  },
  {
    ...
    titleDefault: '学习 Pro Components',
    descDefault:
      'ProComponents 在 Ant Design 基础上提供了更高抽象层次的模板组件，组件即页面的设计理念。',
  },
] as const;
